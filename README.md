# FSK & ASK
# Aim
Write a Python program for the modulation and demodulation of FSK and ASK.
# Tools required
...
# CORRECTION: fs = 1000 is now outside the function
fs = 1000
f1 = 30
f2 = 70
bit_rate = 10
...
# FSK
<img width="1201" height="1012" alt="image" src="https://github.com/user-attachments/assets/5b143ece-619d-4064-9ec5-1830c08ce663" />

# ASK
<img width="1190" height="790" alt="image" src="https://github.com/user-attachments/assets/cc4cdf0b-dbee-4df9-8cbc-94f9d23df059" />

# Results
```
Thus the FSK (Frequency Shift Keying) and ASK(Amplitude Shift Keying) is performed using python
```
